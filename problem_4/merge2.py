...
def main():
    ...
    exposed_time -= (188.22 * 60)
    print "J" + sys.argv[1] + " " + str(exposed_time) + " minutes, " + str(round(exposed_time / 60, 2)) + " hours"
    s = "J" + sys.argv[1] + " " + str(exposed_time)
    finc = "./increasing.dat" 
    tmp = []
    if sys.argv[1] != '01':
        fp = open(finc)
